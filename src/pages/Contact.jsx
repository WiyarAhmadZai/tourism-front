            ...
            >
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Main Office: +93 776 992 603<br />
                      Tour Booking: +93 700 123 456<br />
                      Emergency Support: +93 780 987 654
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      Tour Bookings: bookings@afghanistantourism.gov.af<br />
                      Press & Media: press@afghanistantourism.gov.af
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      Tour Booking: 24/7 Online
                    </p>
                  </div>
                </motion.div>
              </div>
              
              {/* Office Image from public folder */}
              <motion.div 
              ...
              >
                <img 
                  ...
                  alt="Afghanistan Tourism Office" 
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Located in the heart of Kabul, our office is easily accessible and welcomes visitors
            </p>
          </motion.div>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            {/* Using an image from the public folder as a map placeholder */}
            <img 
              src="/images/afghanistan-map.jpg" 
